...
class M59Dashboard(tk.Tk):
    def __init__(self):
        ...
        self.elusion_phrase = tk.StringVar(value='emote separates the earths and forms a path to {loc}')
        ...
        if os.path.exists(SETTINGS_FILE):
            try:
                with open(SETTINGS_FILE, "r") as f:
                    ...
                    self.elusion_phrase.set(s.get("elusion_phrase", 'emote separates the earths and forms a path to {loc}'))
    ...
    def setup_tab_settings(self):
        ...
        tk.Label(elude_g, text="Elusion Phrase (use {loc} for location):", bg="#f0f0f0").pack(anchor="w")
        phrases = [
        ...
        ttk.Combobox(elude_g, textvariable=self.elusion_phrase, values=phrases, width=50).pack(anchor="w", pady=5)
